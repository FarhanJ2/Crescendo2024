...
public class RobotContainer {
    ...
    public static final OdometryImpl s_Odom = new OdometryImpl(s_Swerve);
    ...
    public RobotContainer() {
        ...
        NamedCommands.registerCommand("low ramp", new RampShooter(Constants.ShootingConstants.lowRampRPM, Constants.ShootingConstants.lowRampRPM, Constants.Shooter.homePosition));

        NamedCommands.registerCommand("mid range shot", new ParallelRaceGroup(
                new WaitCommand(4),
                new ParallelDeadlineGroup(
                    new SequentialCommandGroup(
                        new WaitUntilCommand(() -> s_Shooter.isReadyToShoot()),
                    ...
                    new RampShooter(Constants.ShootingConstants.spotOneRPM, Constants.ShootingConstants.spotOneRPM, s_Swerve.odometryImpl.getPivotAngle(alliance))
                )
            )
        );
